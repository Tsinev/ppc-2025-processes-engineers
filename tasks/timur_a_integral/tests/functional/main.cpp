...
class TimurAFuncTestsIntegral : public ppc::util::BaseRunFuncTests<InType, OutType, TestType> {
 public:
...
TEST_P(TimurAFuncTestsIntegral, IntegrationTest) {
...
const auto kPerfTestName = TimurAFuncTestsIntegral::PrintFuncTestName<TimurAFuncTestsIntegral>;

INSTANTIATE_TEST_SUITE_P(IntegrationTests, TimurAFuncTestsIntegral, kGtestValues, kPerfTestName);
}  // namespace
}  // namespace timur_a_integral
