...
class NesterovARunFuncTestsProcesses : public ppc::util::BaseRunFuncTests<InType, OutType, TestType> {
 ...
 protected:
  void SetUp() override {
    ...
    {
      std::string abs_path = ppc::util::GetAbsoluteTaskPath(PPC_ID_timur_a_charcounter, "pic.jpg");
...
const auto kTestTasksList =
    std::tuple_cat(ppc::util::AddFuncTask<TimurACharcounterMPI, InType>(kTestParam, PPC_SETTINGS_timur_a_charcounter),
                   ppc::util::AddFuncTask<TimurACharcounterSEQ, InType>(kTestParam, PPC_SETTINGS_timur_a_charcounter));
