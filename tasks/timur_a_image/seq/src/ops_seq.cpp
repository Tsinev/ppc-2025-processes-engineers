...
TimurAImageSEQ::TimurAImageSEQ(const InType &in) {
  SetTypeOfTask(GetStaticTypeOfTask());
  GetInput() = in;
}

bool TimurAImageSEQ::ValidationImpl() {
...
bool TimurAImageSEQ::PreProcessingImpl() {
  GetOutput() = GetInput();
  return true;
}
...
=======
  auto &out = GetOutput();
>>>>>>> 664ae0c14db57f34cedf8dc3c18546878b604f10
...
bool TimurAImageSEQ::PostProcessingImpl() {
  return true;
}
