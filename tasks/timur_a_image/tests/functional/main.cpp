 ...
 protected:
  void SetUp() override {
    ...
    if (test_name == "small_image") {
      ...
      std::string abs_path = ppc::util::GetAbsoluteTaskPath(PPC_ID_timur_a_image, "pic.jpg");
    ...
    TimurAImageSEQ task(input_data_);
...
TEST_P(TimurAFuncTests, ImageSmooth) {
...
INSTANTIATE_TEST_SUITE_P(ImageSmoothTests, TimurAFuncTests, kGtestValues, kPerfTestName);
